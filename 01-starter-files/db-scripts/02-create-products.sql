-- -----------------------------------------------------
-- Schema full-stack-shop
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `full-stack-shop`;

CREATE SCHEMA `full-stack-shop`;
USE `full-stack-shop` ;

-- -----------------------------------------------------
-- Table `full-stack-shop`.`product_category`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `full-stack-shop`.`product_category` (
...
-- -----------------------------------------------------
-- Table `full-stack-shop`.`product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `full-stack-shop`.`product` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
